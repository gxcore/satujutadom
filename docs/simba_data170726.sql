...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 26, 2017 at 12:29 AM
...
INSERT INTO `request` (`id`, `requestor_id`, `facilitator_id`, `province_id`, `regency_id`) VALUES
(1, 1, 1, 32, 3201),
(2, 2, 12, 19, 1901);
...
(1, '3271010102387002', 'Muda Beragama', 'Syari Maiumunah'),
(2, '32202435010010', 'Lambe Turah', 'Instagram Lambe');
...
INSERT INTO `request_statuses` (`request_id`, `set_id`, `status_id`, `flag`) VALUES
(1, 4, 1, '0'),
(1, 4, 2, '0'),
(1, 4, 3, '0'),
(1, 4, 4, '0'),
...
INSERT INTO `sets` (`id`, `set_name`) VALUES
(4, 'Default');
...
--
-- Dumping data for table `set_status_groups`
--

INSERT INTO `set_status_groups` (`set_id`, `status_id`) VALUES
(4, 1),
(4, 2),
(4, 3),
(4, 4),
...
INSERT INTO `status` (`id`, `sequence`, `status_code`, `description`) VALUES
(1, 10, 'PDF', 'Pendaftaran'),
(2, 20, 'SDV', 'Seleksi & Verifikasi'),
(3, 30, 'EOF', 'Edukasi oleh Fasilitator'),
(4, 40, 'PCPB', 'Pengajuan Calon Penerima Bantuan'),
(5, 50, 'PCEB', 'Penetapan Calon Penerima Bantuan'),
(6, 60, 'PCPDE', 'Penyerahan Calon Penerima Bantuan ke Dit. Ebis'),
(7, 70, 'ADH', 'Aktivasi Domain dan Hosting'),
(8, 80, 'PPB', 'Penetapan Penerima bantuan'),
(9, 90, 'PCDH', 'Penyerahan Credential Domain dan Hosting'),
(10, 100, 'MK', 'Migrasi Konten'),
(11, 110, 'STBP', 'Serah Terima Bantuan Pemerintah');
...
--
ALTER TABLE `regencies`
  MODIFY `id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9475;
--
